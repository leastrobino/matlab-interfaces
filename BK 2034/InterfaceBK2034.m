...
classdef InterfaceBK2034 < handle
  ...
  methods
    ...
    function this = InterfaceBK2034()
      
      % Settings
      this.s.address = 26; % GPIB address
      ...
      this.h.window = UIComponent.Figure(...
        ...
        'Name','Interface Brüel & Kjær 2034  |  hepia',...
        'Size',[1024 768]);
      ...
      % Connect to the Brüel & Kjær 2034, allowing only one instance
      try
        global bk2034_instance %#ok<TLEV>
        if bk2034_instance == 1
          error('InterfaceBK2034:OneInstanceAllowed',...
            'Only one instance of the Brüel & Kjær 2034 interface is allowed.');
        end
        this.h.bk2034 = BK_2034(this.s.address);
        bk2034_instance = 1;
      catch e
        jerrordlg(e.message);
  ...
  methods (Access = private)
    ...
    function closeRequestFcn(this,~,~)
      global bk2034_instance
      try %#ok<TRYNC>
        this.h.window.Visible = 'off';
      end
      try %#ok<TRYNC>
        delete(this.h.bk2034);
        bk2034_instance = 0;
      end
    ...
    function getTrace(this,~,~,~)
      ...
      drawnow();
      try
        [this.d.x,this.d.trace_A,this.d.trace_B,this.d.info] = this.h.bk2034.getTrace();
      catch e
