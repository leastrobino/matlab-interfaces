...
classdef Pendule_de_Pohl < handle
  ...
  methods
    ...
    function this = Pendule_de_Pohl()
      ...
      this.h.window = UIComponent.Figure(...
        ...
        'Name','Pendule de Pohl  |  Laboratoire de physique  |  hepia',...
        'Size',[1024 768]);
      ...
      try
        ...
        this.h.phidget = PhidgetEncoder('Pohl');
  ...
  methods (Access = private)
    ...
    function zoomActionPost(this,~,~)
      ...
      if all(this.h.axes.YLim == [-150 150])
        this.h.axes.YTick = -150:30:150;
      else
